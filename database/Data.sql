...
VALUES (1, 'Ahmed', 'Ali', 'Hassan', TO_DATE('1985-05-15', 'YYYY-MM-DD'), 'Tahrir St', 'Dokki', 'Giza', '28505152100123', 'ahmed@email.com', 'ahmed_hassan', '$2b$10$bLFttGKghDfd8eFoo8batOAKGdLA8YwgxFmx2hl.q5OeztTFw8iM6');

INSERT INTO Customer (Customer_ID, First_name, Middle_Name, Last_name, DOB, Street, City, Governorate, National_ID, Email, Username, Password)
VALUES (2, 'Fatma', 'Mahmoud', 'Ibrahim', TO_DATE('1992-11-20', 'YYYY-MM-DD'), 'Nile Corniche', 'Maadi', 'Cairo', '29211200100456', 'fatma@email.com', 'fatma_ibrahim', '$2b$10$bLFttGKghDfd8eFoo8batOAKGdLA8YwgxFmx2hl.q5OeztTFw8iM6');
